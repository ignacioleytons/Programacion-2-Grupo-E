...
def cargar_desde_archivo_paciente():
    try:
        with open("paciente.text","r", encoding="utf-8") as archivo:
            paciente_data.clear()
        ...
        open("paciente.text","p",encoding="utf-8").close()
...
def registrarDoctores():
    ...
    #cargar el treeview de doctores
    cargar_treeviewD()
...
cargar_desde_archivo_paciente() #cargar datos desde el archivo al iniciar la aplicacion
